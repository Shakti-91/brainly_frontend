...
import { DeleteIcon, Youtube } from "../assets/Icons"
            ...
            return(
                <div className="h-screen w-screen fixed top-0 left-0  bg-black/50 z-30 flex justify-center items-center">
                   ...
                   <div className="bg-white z-50 opacity-100 flex flex-col h-74 w-88 rounded-md">
                    <div onClick={props.onClose} className="w-full flex justify-end p-4 text-red-500 cursor-pointer"><DeleteIcon/></div>
                    <div className="items-center justify-between  gap-4 mb-6 ml-6 mr-6 flex-col flex">
                    <input type="text" ref={titleRef} className="h-12 w-72 border border-gray-300 rounded-md" placeholder="Title" />
                    <input type="text" ref={linkRef} className="h-12 w-72 border border-gray-300 rounded-md" placeholder="Link" />
